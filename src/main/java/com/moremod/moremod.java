...
import com.moremod.capability.module.impl.FireExtinguishModule;
import com.moremod.capability.module.impl.DamageBoostModule;
import com.moremod.capability.module.impl.AttackSpeedModule;
import com.moremod.capability.module.impl.RangeExtensionModule;
import com.moremod.capability.module.impl.PursuitModule;
import com.moremod.capability.module.impl.KineticGeneratorModule;
import com.moremod.capability.module.impl.SolarGeneratorModule;
import com.moremod.capability.module.impl.VoidEnergyModule;
import com.moremod.capability.module.impl.CombatChargerModule;
import com.moremod.capability.module.impl.MovementSpeedModule;
import com.moremod.capability.module.impl.StealthModule;
import com.moremod.capability.module.impl.ExpAmplifierModule;
import com.moremod.capability.module.impl.OreVisionModule;
import com.moremod.capability.module.impl.MagicAbsorbModule;
...
public class moremod {
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        ModuleRegistry.registerNew(ThornsModule.INSTANCE);
        ModuleRegistry.registerNew(FireExtinguishModule.INSTANCE);
        ModuleRegistry.registerNew(DamageBoostModule.INSTANCE);
        ModuleRegistry.registerNew(AttackSpeedModule.INSTANCE);
        ModuleRegistry.registerNew(RangeExtensionModule.INSTANCE);
        ModuleRegistry.registerNew(PursuitModule.INSTANCE);
        ModuleRegistry.registerNew(KineticGeneratorModule.INSTANCE);
        ModuleRegistry.registerNew(SolarGeneratorModule.INSTANCE);
        ModuleRegistry.registerNew(VoidEnergyModule.INSTANCE);
        ModuleRegistry.registerNew(CombatChargerModule.INSTANCE);
        ModuleRegistry.registerNew(MovementSpeedModule.INSTANCE);
        ModuleRegistry.registerNew(StealthModule.INSTANCE);
        ModuleRegistry.registerNew(ExpAmplifierModule.INSTANCE);
        ModuleRegistry.registerNew(OreVisionModule.INSTANCE);
        ModuleRegistry.registerNew(MagicAbsorbModule.INSTANCE);
...
// 在主类/代理类中
    ...
    private void registerMechanicalCoreSystem() {
        try {
            MinecraftForge.EVENT_BUS.register(com.moremod.eventHandler.LootTableHandler.class);
