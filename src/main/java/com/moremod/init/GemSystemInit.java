...
import com.moremod.compat.crafttweaker.GemLootGenerator;
...
public class GemSystemInit {
    ...
    public static void init(FMLInitializationEvent event) {
        ...
        if (ModItems.GEM != null) {
            GemLootGenerator.setBaseGemItem(new ItemStack(ModItems.GEM));
        ...
        // 注册掉落事件监听器
        MinecraftForge.EVENT_BUS.register(new GemLootGenerator());
